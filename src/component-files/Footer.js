...
const Footer = () => {
  return (
    <div className="footerdiv">
      <footer className="footers d-flex flex-wrap justify-content-between align-items-center py-3 my-4  ">
        ...
        <div className="col-md-4 list-unstyled text-end justify-content-center">
          <p className="alignheader row-md-4">Chief Advocate</p>
          <p className="align row-md-4">Shankar Raj  <span className="alignspan"> B.A.B.L, L.L.B.</span></p>
          <br/>
          <p className="alignheader row-md-4">Contact Us </p>
          <ul className="nav row-md-4 list-unstyled d-flex justify-content-end">
            <li className="ms-3">
              <a href="mailto: techief@gmail">
